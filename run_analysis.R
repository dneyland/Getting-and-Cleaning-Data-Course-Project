...
colnames(by_subj_act) <-  gsub("^t", "Time", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("^f", "Frequency", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("Acc", "Accelerometer", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("Gyro", "Gyroscope", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("Mag", "Magnitude", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("meanFreq", "MeanFrequency", colnames(by_subj_act))
colnames(by_subj_act) <-  gsub("std", "StandardDeviation", colnames(by_subj_act))
